<?php     
  ...
  function loginform() {
        echo "<form id='index-form' action='./validatelogin.php' method='POST'>
...
function logout()
    {
        ...
        <form action='./logout.php' method ='GET' type='button' class='btn btn-primary' data-toggle='modal' data-target='.bd-example-modal-lg'>
